...
private val PsiElement.contextWithoutIndexAccess: PsiElement?
    get() = if (this is RsExpandedElement) RsExpandedElement.getContextImplWithoutIndexAccess(this) else stubParent

@Suppress("UNCHECKED_CAST")
private fun <T : PsiElement> PsiElement.findContextOfTypeWithoutIndexAccess(strict: Boolean, vararg classes: KClass<out T>): T? {
    var element: PsiElement? = if (strict) this.contextWithoutIndexAccess else this
